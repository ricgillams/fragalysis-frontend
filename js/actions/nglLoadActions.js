...
import {
    ...
    DELETE_OBJECT_TYPE, SET_ORIENTATION, SET_NGL_ORIENTATION, SET_UUID, SET_UPDATE_STATE,
    SET_LOADING_STATE, SET_STAGE_COLOR, SET_NGL_PROT_STYLE
} from './actonTypes'
...
export const updateState = function (updateState){
        console.log("ACTIONS: " + updateState);
    return {
